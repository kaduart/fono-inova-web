...
import { ITherapyPackage } from '../../utils/types';
                        ...
                        <table className="min-w-full table-auto bg-white rounded-lg shadow-md">
                            ...
                            <tbody className="text-gray-700">
                                {packages && packages.map((pkg) => {
                                    ...
                                    return (
                                        <tr key={pkg._id} className="border-t border-gray-200 hover:bg-gray-50 transition-colors duration-200">
                                            <td className="p-4">{pkg.patientId}</td>
                                            <td className="p-4">{pkg.sessionType}</td>
                                            <td className="p-4">{pkg.totalSessions} / {pkg.totalSessions}</td>
                                            <td className="p-4">
                                                {lastSession
