...
const WHATSAPP_URL =
  "https://wa.me/5562992013573?text=Olá! Vi o site da Clínica Fono Inova e gostaria de agendar uma avaliação de fisioterapia infantil.";
          ...
          <div className="flex flex-col lg:grid lg:grid-cols-2 gap-12 lg:gap-16 items-center min-h-[80vh]">
            ...
            <div className="order-2 lg:order-1 space-y-6">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold font-poppins text-slate-900 leading-tight">
                <TypewriterText text="Fisioterapia Infantil em Anápolis" />
              </h1>
