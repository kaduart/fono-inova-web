...
import { schemaBaseLocalBusiness, schemaBaseAereaAnapolis, schemaFAQBaseAereaAnapolis } from '../schemas/clinicaSchemas.js';
import Breadcrumb from '../components/Breadcrumb';

const WHATSAPP_MESSAGE =
  "Oi! Sou da Base Aérea de Anápolis (BAAN) e gostaria de saber como agendar uma avaliação pelo convênio. Pode me orientar?";
...
const steps = [
  {
    ...
    description: "Confirme com nossa equipe a cobertura do convênio BAAN para o atendimento que precisa",
    icon: MessageCircle,
  },
  {
    number: "2",
...
const beneficios = [
  "Credenciados ao convênio da Base Aérea de Anápolis (BAAN)",
  "A poucos minutos da Base, no bairro Jundiaí",
  "Atendimento multidisciplinar para militares e dependentes",
];

const BaseAereaAnapolis = () => {
  const [accessibilityWizardOpen, setAccessibilityWizardOpen] = useState(false);
  const { trackFormSubmission } = useFormTracking('LP_Base_Aerea_Anapolis');
  ...
  return (
    <Layout>
      ...
      <SEO
        title="Convênio Base Aérea em Anápolis (BAAN) | Fono Inova"
        description="Clínica Fono Inova credenciada ao convênio da Base Aérea de Anápolis (BAAN). Fonoaudiologia, psicologia, terapia ocupacional e fisioterapia infantil no bairro Jundiaí. Agende pelo WhatsApp (62) 99201-3573."
        keywords="convenio base aerea anapolis, clinica atende base anapolis, baan anapolis, fonoaudiologia base aerea anapolis, convenio baan"
        image="/images/og-image.jpg"
        url="https://www.clinicafonoinova.com.br/convenio-base-aerea-anapolis"
        type="website"
        schema={[schemaBaseLocalBusiness, schemaBaseAereaAnapolis, schemaFAQBaseAereaAnapolis]}
      />
          ...
          <div className="flex flex-col lg:grid lg:grid-cols-2 gap-12 lg:gap-16 items-center min-h-[80vh]">
            ...
            <div className="order-2 lg:order-1 space-y-6">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold font-poppins text-slate-900 leading-tight">
                <TypewriterText text="Você é da Base Aérea de Anápolis e Procura Atendimento para seu Filho?" />
              </h1>

              {/* H2 - REASSURANCE */}
              <h2 className="text-xl md:text-2xl font-medium text-slate-600">
                A Fono Inova é credenciada ao convênio da Base Aérea de Anápolis (BAAN) — a poucos minutos da Base, no bairro Jundiaí
              </h2>

              {/* Parágrafo */}
              <p className="text-lg text-slate-600 leading-relaxed max-w-xl">
                Somos credenciados ao <strong className="text-slate-900">convênio da Base Aérea de Anápolis (BAAN)</strong> e atendemos militares e dependentes com <strong>fonoaudiologia</strong>, <strong>psicologia infantil</strong>, <strong>terapia ocupacional</strong> e <strong>fisioterapia</strong>. Atendimento acolhedor, explicação clara e orientação prática em cada etapa.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-2">
                <ButtonWhatsApp
                  onClick={() => {
                    ...
                    trackButtonClick?.("WhatsApp LP Base Aerea Anapolis");
                  }}
                ...
                >
                  Quero agendar pelo convênio BAAN
                </ButtonWhatsApp>
              ...
              <div className="relative">
                ...
                <div className="absolute -bottom-4 -right-4 bg-white rounded-xl p-4 shadow-xl z-10">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-bold text-slate-900 text-sm">Credenciados BAAN</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold font-poppins text-slate-900 mb-4">
              Como funciona o atendimento pelo convênio BAAN
            </h2>
      ...
      <section className="py-24 bg-slate-50">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold font-poppins text-slate-900 mb-4">
              Perguntas Frequentes sobre o Convênio BAAN
            </h2>
          </div>

          <div className="max-w-3xl mx-auto space-y-4">
            {schemaFAQBaseAereaAnapolis.mainEntity.map((item, index) => (
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12 max-w-4xl mx-auto text-center border-2 border-primary/10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              <ButtonWhatsApp
                onClick={() => trackButtonClick("WhatsApp - CTA Final Base Aerea")}
            ...
            <div className="pt-8 border-t border-slate-200">
              <div className="flex items-center justify-center gap-2 text-slate-600 mb-2">
                ...
                <span className="font-medium">Clínica Fono Inova — próxima à Base Aérea de Anápolis</span>
              </div>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <h3 className="text-2xl font-bold text-slate-900 mb-6 text-center">
              Especialidades atendidas pelo convênio BAAN
            </h3>
...
export default BaseAereaAnapolis;
