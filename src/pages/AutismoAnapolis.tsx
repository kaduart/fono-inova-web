...
export default function AutismoAnapolis() {
  ...
  return (
    <Layout>
      ...
      <Breadcrumb items={[
        { label: 'Avaliação TEA', href: '/artigos/suspeita-autismo-avaliacao-completa' },
      ...
      <section className="relative min-h-[90vh] pt-24 pb-16 md:pt-28 overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 lg:px-8 max-w-3xl">
          <div className="space-y-6 text-center pt-8">
            ...
            <span className="inline-flex items-center bg-purple-50 text-purple-700 border border-purple-200 px-4 py-1.5 text-sm font-semibold rounded-full">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold font-poppins text-slate-900 leading-tight">
              <TypewriterText text="Você Suspeita que Seu Filho Pode Ter Autismo?" />
            </h1>
