...
const TeaPage = () => {
    ...
    const sinaisPorIdade = [
        {
            ...
            mensagem: "Oi! Tenho suspeita de autismo no meu filho. Meu bebê tem 6-12 meses e notei pouco contato visual/não responde ao nome. O que devo fazer?"
        },
        {
            idade: '1-2 anos',
            sinais: ['Não fala palavras', 'Não brinca de faz de conta', 'Movimentos repetitivos', 'Não segue comandos'],
            mensagem: "Oi! Tenho suspeita de autismo no meu filho. Meu filho tem 1-2 anos e ainda não fala/faz movimentos repetitivos. O que devo fazer?"
        },
        {
            idade: '2-3 anos',
            sinais: ['Fala pouco ou não fala', 'Não interage com outras crianças', 'Rotinas rígidas', 'Sensibilidade a sons/luzes'],
            mensagem: "Oi! Tenho suspeita de autismo no meu filho. Meu filho tem 2-3 anos e fala pouco/não brinca com outras crianças. O que devo fazer?"
        },
        {
            idade: '3+ anos',
            sinais: ['Dificuldade na escola', 'Comportamentos desafiadores', 'Comunicação limitada', 'Interesses restritos'],
            mensagem: "Oi! Tenho suspeita de autismo no meu filho. Meu filho tem 3+ anos e tem dificuldade na escola/comunicação. O que devo fazer?"
        }
    ];
    ...
    const beneficios = [
        ...
        },
        {
            ...
            description: 'Quanto mais cedo entender, maiores os ganhos no desenvolvimento da criança'
        },
        {
            icon: Heart,
    ...
    const depoimentos = [
        {
            ...
            resultado: "Clareza e direção para a família"
        },
        {
            estrelas: 5,
            texto: "Iniciamos o acompanhamento aos 2 anos e meio. A explicação clara nos deu segurança para ajudar nosso filho.",
            autor: "Pai da Laura, 3 anos",
            resultado: "Segurança para os pais"
        },
        {
            estrelas: 5,
    ...
    const etapasAvaliacao = [
        ...
        },
        {
            ...
            descricao: 'Diagnóstico detalhado com plano de orientação individualizado'
        },
        {
            passo: '4',
            titulo: 'Início do Acompanhamento',
            descricao: 'Orientações coordenadas para melhor desenvolvimento da criança'
        }
    ];
    ...
    const faq = [
        {
            ...
            resposta: 'Alguns sinais podem ser observados a partir dos 12-18 meses. A avaliação precoce geralmente ocorre entre 2-3 anos, mas quanto antes buscar orientação, melhor para a criança.'
        },
        {
            pergunta: 'Autismo tem cura?',
            resposta: 'O TEA não é uma doença, mas uma condição do neurodesenvolvimento. Com orientação precoce e adequada, a criança pode desenvolver habilidades importantes e ter uma vida plena e feliz.'
        },
        {
    ...
    // Sinais de alerta para o bloco de dor
    const sinaisAlerta = [
        "Não fala ou fala pouco para a idade",
        "Não responde quando é chamado",
        "Evita contato visual",
        "Não brinca com outras crianças",
        "Agitação ou dificuldade de atenção"
    ];

    return (
        <Layout>
            <SEO
                title="Suspeita de Autismo? Avaliação TEA em Anápolis"
                description="Você suspeita de autismo no seu filho? Avaliação de TEA multidisciplinar no bairro Jundiaí, Anápolis. Entenda o que está acontecendo com orientação inicial."
                keywords="suspeita autismo anapolis, avaliacao tea anapolis, fonoaudiologia autismo, psicologo autismo jundiai, crianca nao responde nome"
                        ...
                        <div className="order-2 lg:order-1">
                            ...
                            <div className="bg-amber-50 border-l-4 border-amber-400 p-4 rounded-r-xl mb-6">
                                <p className="text-amber-900 text-sm">
                                    <strong>A Janela de Oportunidade:</strong> A orientação entre 2-5 anos é crucial. 
                            ...
                            {/* CTA Principal - ATUALIZADO */}
                            <div className="flex flex-col sm:flex-row gap-4">
                                <ButtonWhatsApp
                                    message="Oi! Tenho suspeita de autismo no meu filho, o que devo fazer?"
                            ...
                            <p className="text-sm text-slate-500 mt-3">
                                Orientação multidisciplinar • Sem encaminhamento
                            </p>
                        </div>
                            ...
                            <div className="absolute -bottom-4 -left-4 bg-white p-5 rounded-2xl shadow-xl border border-slate-100 animate-float">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-sm text-slate-500">Famílias orientadas</div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="text-center mt-10">
                        <ButtonWhatsApp
                            message={selectedSinal 
                                ...
                                : "Oi! Tenho suspeita de autismo no meu filho, o que devo fazer?"}
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
                        <div>
                            ...
                            <h2 className="text-3xl md:text-4xl font-bold font-poppins mb-6">
                                Por Que a <span className="text-purple-600">Orientação Precoce</span> é Essencial?
                            </h2>
                            <p className="text-slate-600 mb-4 leading-relaxed">
                                ...
                                o que significa que orientações iniciadas cedo têm impacto muito maior.
                            </p>
                            <p className="text-slate-600 mb-6 leading-relaxed">
                                Estudos mostram que crianças que iniciam acompanhamento antes dos 3 anos apresentam 
                            ...
                            <div className="bg-purple-50 p-6 rounded-xl border-l-4 border-purple-600">
                                ...
                                <p className="text-slate-700">
                                    Não existe "esperar para ver". Cada mês sem orientação adequada é uma 
                        ...
                        <div>
                            <img
                                ...
                                alt="Orientação multidisciplinar"
            ...
            <section className="py-20 bg-slate-50">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-lg text-slate-600 max-w-2xl mx-auto">
                            Orientação completa com equipe multidisciplinar especializada em TEA
                        </p>
                    </div>
                    ...
                    <div className="max-w-6xl mx-auto">
                        <div className="text-center mb-10">
                            <h3 className="text-2xl md:text-3xl font-bold font-poppins mb-2">
                                Como Funciona a <span className="text-purple-600">Orientação</span>
                            </h3>
                ...
                <div className="container mx-auto px-4 max-w-3xl">
                    <div className="bg-white rounded-2xl shadow-lg p-8 border border-amber-200">
                        ...
                        <ul className="space-y-3 mb-6">
                            ...
                            <li className="flex items-start gap-3 text-slate-700">
                                <CheckCircle2 className="w-5 h-5 text-amber-500 flex-shrink-0 mt-0.5" />
                                <span>Os sinais estão persistindo há meses</span>
                            </li>
                            <li className="flex items-start gap-3 text-slate-700">
                                <CheckCircle2 className="w-5 h-5 text-amber-500 flex-shrink-0 mt-0.5" />
                                <span>A escola ou pediatra já sinalizou preocupação</span>
                            </li>
                            <li className="flex items-start gap-3 text-slate-700">
                                <CheckCircle2 className="w-5 h-5 text-amber-500 flex-shrink-0 mt-0.5" />
                        ...
                        <div className="bg-purple-50 border border-purple-200 p-4 rounded-xl mb-6">
                            <p className="text-purple-800 text-center font-medium">
                                <strong>Quanto antes identificar sinais de autismo,</strong> mais cedo é possível 
                                iniciar o acompanhamento adequado e ajudar no desenvolvimento da criança.
                            </p>
                        </div>

                        <div className="text-center">
                            <ButtonWhatsApp
                                message="Oi! Tenho suspeita de autismo no meu filho. Gostaria de agendar uma avaliação."
                                className="bg-green-600 hover:bg-green-700 text-white px-8 py-4 rounded-xl font-bold shadow-lg transition-all inline-flex items-center gap-2"
                            >
            ...
            <section className="py-12 bg-white border-t border-slate-100">
                <div className="container mx-auto px-4 max-w-3xl text-center">
                    <p className="text-slate-600 mb-4">
                        Para investigação médica completa do desenvolvimento, também contamos com <strong>neuropediatra</strong> em nossa equipe.
                    </p>
                    <a 
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        <p className="text-xl text-white/80 mb-8">
                            Tire suas dúvidas com nossa equipe especializada. A orientação traz 
                        ...
                        <div className="bg-white p-8 rounded-3xl shadow-2xl text-slate-900 mb-8">
                            <h3 className="text-2xl font-bold mb-3 text-purple-600">
                                Orientação Multidisciplinar Completa
                            </h3>
