...
const painPoints = [
  {
    ...
    description: "Tropeça muito, tem dificuldade para pegar objetos ou fazer movimentos finos",
    color: "orange",
    link: "/psicomotricidade-anapolis",
    whatsappMsg: "Oi! Vi o site da Clínica Fono Inova 💚\nMeu filho tem dificuldade de coordenação motora. Pode me orientar?",
  },
  {
    icon: Activity,
    title: "Problemas de equilíbrio e postura",
    description: "Senta curvado, tem dificuldade para manter-se em pé ou se cansar rapidamente",
    color: "blue",
    link: "/psicomotricidade-anapolis",
    whatsappMsg: "Oi! Vi o site da Clínica Fono Inova 💚\nMeu filho tem problema de equilíbrio/postura. Pode me orientar?",
  },
  {
    icon: Target,
    title: "Dificuldade com atividades escolares",
    description: "Não consegue segurar lápis direito, recorta com dificuldade ou evita atividades motoras",
    color: "purple",
    link: "/psicomotricidade-anapolis",
    whatsappMsg: "Oi! Vi o site da Clínica Fono Inova 💚\nMeu filho tem dificuldade nas atividades escolares motoras. Pode me orientar?",
  },
  {
    icon: Brain,
    title: "Desorganização corporal",
    description: "Não reconhece direita/esquerda, confunde partes do corpo ou parece desatento ao próprio corpo",
    color: "emerald",
    link: "/psicomotricidade-anapolis",
    whatsappMsg: "Oi! Vi o site da Clínica Fono Inova 💚\nMeu filho parece ter desorganização corporal. Pode me orientar?",
  },
  {
    icon: Baby,
    title: "Atraso no desenvolvimento motor",
    description: "Engatinhou tarde, começou a andar depois dos 18 meses ou apresenta movimentos travados",
    color: "pink",
    link: "/psicomotricidade-anapolis",
  ...
  {
    icon: Zap,
    title: "Insegurança nos movimentos",
    description: "Evita brincadeiras no parquinho, tem medo de escorregar ou não gosta de atividades físicas",
    color: "teal",
    link: "/psicomotricidade-anapolis",
    whatsappMsg: "Oi! Vi o site da Clínica Fono Inova 💚\nMeu filho é muito inseguro nos movimentos. Pode me orientar?",
  },
];
...
const steps = [
  {
    ...
    description: "Tire suas dúvidas sobre psicomotricidade com nossa equipe",
    icon: MessageCircle,
  },
  {
    number: "2",
    title: "Avaliação especializada",
    description: "Avaliamos a coordenação motora, equilíbrio e planejamento do seu filho",
    icon: Brain,
  },
  {
    number: "3",
    title: "Início da terapia",
    description: "Comece o tratamento personalizado com exercícios lúdicos e eficazes",
    icon: CheckCircle2,
  },
];
...
const featuredTestimonials = [
  {
    stars: 5,
    text: "Minha filha tropeçava muito e não conseguia segurar o lápis. Depois de 6 meses, já escreve e desenha!",
    author: "Mãe da Clara, 5 anos",
  },
  {
    stars: 5,
    text: "O desenvolvimento da coordenação motora foi impressionante. Agora ele brinca no parque com confiança.",
    author: "Pai do Miguel, 4 anos",
  },
  {
    stars: 5,
    text: "Atendimento excelente! Os exercícios são lúdicos e meu filho adora as sessões.",
    author: "Mãe da Júlia, 6 anos",
  },
];

const PsicomotricidadeAnapolis = () => {
  ...
  const { trackFieldInteraction, trackFormSubmission } = useFormTracking('LP_Psicomotricidade_Anapolis');
  ...
  return (
    <Layout>
      ...
      <SEO
        title="Psicomotricidade Infantil em Anápolis | Coordenação Motora e Equilíbrio | Clínica Fono Inova"
          ...
          <div className="flex flex-col lg:grid lg:grid-cols-2 gap-12 lg:gap-16 items-center min-h-[80vh]">
            ...
            <div className="order-2 lg:order-1 space-y-6">
              ...
              <h2 className="text-2xl md:text-3xl font-semibold text-slate-700">
                Coordenação motora, equilíbrio e planejamento
              </h2>

              {/* H2 Dor */}
              <p className="text-xl md:text-2xl text-slate-700 leading-relaxed max-w-xl font-medium">
                Seu filho apresenta dificuldade de coordenação, postura ou controle motor?
              </p>

              {/* Parágrafo */}
              <p className="text-lg text-slate-600 leading-relaxed max-w-xl">
                A <strong className="text-slate-900">Clínica Fono Inova</strong> em{" "}
                <strong className="text-slate-900">Anápolis</strong> ajuda crianças a desenvolverem coordenação motora,
                equilíbrio e controle corporal através de exercícios lúdicos e especializados.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-2">
                <ButtonWhatsApp
                  onClick={() => {
                    ...
                    trackButtonClick?.("WhatsApp LP Psicomotricidade");
                  }}
                  ...
                  message="Oi! Vi o site sobre psicomotricidade em Anápolis 💚\nMeu filho tem dificuldade de coordenação. Pode me orientar?"
                >
              ...
              <div className="relative">
                <div className="w-full h-72 sm:h-96 md:h-[450px] rounded-3xl overflow-hidden shadow-2xl">
                  <img 
                    ...
                    alt="Psicomotricidade Infantil em Anápolis - Atendimento especializado"
        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <div className="text-center mt-12">
            ...
            <ButtonWhatsApp
              ...
              message={selectedPain !== null ? painPoints[selectedPain].whatsappMsg : "Oi! Vi o site sobre psicomotricidade 💚\nQuero saber se meu filho precisa de atendimento."}
            >
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold font-poppins text-slate-900 mb-4">
              Como funciona o tratamento de psicomotricidade
            </h2>
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              Em 3 passos simples, seu filho começa a desenvolver coordenação motora e equilíbrio
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12 max-w-4xl mx-auto text-center border-2 border-primary/10">
            ...
            <p className="text-lg text-slate-600 mb-8 max-w-2xl mx-auto">
              Cada dia de espera é um dia de atraso no desenvolvimento motor. 
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              <ButtonWhatsApp
                ...
                message="Oi! Vi o site sobre psicomotricidade 💚\nQuero agendar uma avaliação para meu filho."
              >
...
export default PsicomotricidadeAnapolis;
