        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="animate-fade-in-up order-2 lg:order-1">
              <span className="mb-4 inline-flex items-center bg-blue-50 text-blue-700 border border-blue-100 px-3 py-1 text-xs uppercase tracking-wider font-semibold rounded-full">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold font-poppins text-slate-900 leading-tight mb-6">
                <TypewriterText segments={[
                    { text: 'Desbloqueie o Potencial da ' },
                    { text: 'Comunicação', className: 'text-blue-600' },
                    { text: ' do Seu Filho' },
                ]} />
              </h1>
      ...
      <section className="py-12 bg-gray-50 border-t border-gray-200">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex justify-center gap-4 mt-2 text-sm">
            ...
            <a href="/fala-tardia-anapolis" className="text-blue-600 hover:underline">Fala Tardia</a>
            <a href="/teste-da-linguinha-anapolis" className="text-blue-600 hover:underline">Teste da Linguinha</a>
          </div>
        </div>
      </section>
