...
import { schemaBaseLocalBusiness, schemaGeapAnapolis, schemaFAQGeapAnapolis } from '../schemas/clinicaSchemas.js';
import Breadcrumb from '../components/Breadcrumb';

const WHATSAPP_MESSAGE =
  "Oi! Tenho o convênio GEAP e gostaria de saber como agendar uma avaliação. Pode me orientar?";
...
const steps = [
  {
    ...
    description: "Confirme com nossa equipe a cobertura do convênio GEAP para o atendimento que precisa",
    icon: MessageCircle,
  },
  {
    number: "2",
...
const GeapAnapolis = () => {
  ...
  const { trackFormSubmission } = useFormTracking('LP_Geap_Anapolis');
  ...
  return (
    <Layout>
      ...
      <SEO
        title="Convênio GEAP em Anápolis | Fono Inova"
        description="Clínica Fono Inova credenciada ao convênio GEAP. Fonoaudiologia, psicologia, terapia ocupacional e fisioterapia infantil no bairro Jundiaí. Agende pelo WhatsApp (62) 99201-3573."
        keywords="convenio geap anapolis, clinica atende geap anapolis, geap anapolis, fonoaudiologia geap anapolis, convenio geap"
        image="/images/og-image.jpg"
        url="https://www.clinicafonoinova.com.br/convenio-geap-anapolis"
        type="website"
        schema={[schemaBaseLocalBusiness, schemaGeapAnapolis, schemaFAQGeapAnapolis]}
      />
          ...
          <div className="flex flex-col lg:grid lg:grid-cols-2 gap-12 lg:gap-16 items-center min-h-[80vh]">
            ...
            <div className="order-2 lg:order-1 space-y-6">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold font-poppins text-slate-900 leading-tight">
                <TypewriterText text="Você Tem o Convênio GEAP e Procura Atendimento para seu Filho?" />
              </h1>

              {/* H2 - REASSURANCE */}
              <h2 className="text-xl md:text-2xl font-medium text-slate-600">
                A Fono Inova é credenciada ao convênio GEAP — atendimento no bairro Jundiaí, em Anápolis
              </h2>

              {/* Parágrafo */}
              <p className="text-lg text-slate-600 leading-relaxed max-w-xl">
                Somos credenciados ao <strong className="text-slate-900">convênio GEAP</strong> e atendemos com <strong>fonoaudiologia</strong>, <strong>psicologia infantil</strong>, <strong>terapia ocupacional</strong> e <strong>fisioterapia</strong>. Atendimento acolhedor, explicação clara e orientação prática em cada etapa.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-2">
                <ButtonWhatsApp
                  onClick={() => {
                    ...
                    trackButtonClick?.("WhatsApp LP Geap Anapolis");
                  }}
                ...
                >
                  Quero agendar pelo convênio GEAP
                </ButtonWhatsApp>
              ...
              <div className="relative">
                <div className="w-full h-72 sm:h-96 md:h-[450px] rounded-3xl overflow-hidden shadow-2xl">
                  <img loading="lazy" decoding="async"
                    src="/images/clinica/sala-ludica.png"
                    alt="Sala lúdica da Clínica Fono Inova - Bairro Jundiaí, Anápolis"
                ...
                <div className="absolute -bottom-4 -right-4 bg-white rounded-xl p-4 shadow-xl z-10">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-bold text-slate-900 text-sm">Credenciados GEAP</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold font-poppins text-slate-900 mb-4">
              Como funciona o atendimento pelo convênio GEAP
            </h2>
      ...
      <section className="py-24 bg-slate-50">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold font-poppins text-slate-900 mb-4">
              Perguntas Frequentes sobre o Convênio GEAP
            </h2>
          </div>

          <div className="max-w-3xl mx-auto space-y-4">
            {schemaFAQGeapAnapolis.mainEntity.map((item, index) => (
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12 max-w-4xl mx-auto text-center border-2 border-primary/10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              <ButtonWhatsApp
                onClick={() => trackButtonClick("WhatsApp - CTA Final Geap")}
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <h3 className="text-2xl font-bold text-slate-900 mb-6 text-center">
              Especialidades atendidas pelo convênio GEAP
            </h3>
