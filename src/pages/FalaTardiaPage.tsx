                ...
                <div className="container mx-auto px-4">
                    <div className="flex flex-col lg:grid lg:grid-cols-2 gap-10 items-center">
                        ...
                        <div className="order-2 lg:order-1">
                            ...
                            <span className="mb-4 inline-flex items-center bg-orange-50 text-orange-700 border border-orange-200 px-3 py-1 text-xs uppercase tracking-wider font-semibold rounded-full">
                            ...
                            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold font-poppins text-slate-900 leading-tight mb-4">
                                <TypewriterText segments={[
                                    { text: 'Seu Filho Já Tem ' },
                                    { text: '2 ou 3 Anos', className: 'text-orange-600' },
                                    { text: ' e Ainda Não Fala Frases?' },
                                ]} />
                            </h1>
