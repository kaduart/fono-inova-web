...
export const articlesData = [
  {
    id: 1,
    slug: "como-estimular-linguagem-criancas",
    title: "Como Estimular a Linguagem nas Crianças",
    excerpt: "Dicas práticas para pais ajudarem no desenvolvimento da fala de seus filhos.",
 ...
 image: "https://images.unsplash.com/photo-1577896851231-70ef18881754?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80",
    content: (
      <>
        <p>O desenvolvimento da linguagem é um processo fundamental na primeira infância. Como pais, existem várias estratégias que podem ser implementadas no dia a dia para estimular essa habilidade crucial.</p>
        
        <h2>1. Conversar constantemente com a criança</h2>
        <p>Desde os primeiros meses de vida, é importante conversar com o bebê durante as atividades cotidianas, como troca de fraldas, banho e alimentação. Use uma voz calma e articule bem as palavras.</p>
        
        <h2>2. Ler histórias infantis</h2>
        <p>A leitura de livros apropriados para a idade estimula o vocabulário e a compreensão. Faça vozes diferentes para os personagens e aponte para as figuras enquanto nomeia os objetos.</p>
        
        <h2>3. Cantar músicas e rimas</h2>
        <p>As cantigas infantis e rimas ajudam no desenvolvimento da consciência fonológica, que é a capacidade de perceber e manipular os sons da fala.</p>
        
        <h2>4. Brincar com jogos de nomeação</h2>
        <p>Jogos que envolvam nomear partes do corpo, objetos da casa ou animais são excelentes para expandir o vocabulário.</p>
        
        <h2>5. Evitar a "linguagem de bebê"</h2>
        <p>Use sempre a forma correta das palavras, mesmo que a criança ainda não consiga pronunciá-las perfeitamente.</p>
        
        <p>Lembre-se: cada criança tem seu próprio ritmo de desenvolvimento. Se notar atrasos significativos na aquisição da linguagem, consulte um fonoaudiólogo para uma avaliação especializada.</p>
      </>
    )
  },
  {
    ...
    title: "Entendendo o Espectro Autista",
